...
***Зам.*** [[Метрики и оценка качества модели|Метрика]] качества предсказания модели должна отличаться от [[Функционалы потерь|функции потерь]]! *(переобучение, не дифференцируемость)*
...
## Важно
Помимо технической части, ml-специалисту также важно уметь интегрировать своё  исследование (или разработку отдельной модели) в пайплайн работы всей команды. Правила координации работы команды data science, а также все best practices излагаются дисциплиной [[0 ML-OPS Оглавление]]. 
